...
onemil              = 1000000.0
#Conversion:
forest_to_ag['conv'] = forest_to_ag['conv'] / onemil
# Ag deaths:
...
df_ae.plot(column='total', cmap=mycmap, linewidth=0.8, ax=ax, edgecolor='None', norm=plt.Normalize(vmin=vmin, vmax=vmax))

plt.savefig('./plots/forestdeaths.png', bbox_inches='tight',dpi=300)
