...
df_ae.plot(column='agdeaths', cmap=mycmap, linewidth=0.8, ax=ax, edgecolor='None', norm=plt.Normalize(vmin=vmin, vmax=vmax))

plt.savefig('./plots/agdeaths.png', bbox_inches='tight',dpi=300)
